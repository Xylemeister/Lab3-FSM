...
VL_INLINE_OPT void Vf1fsm___024root___sequent__TOP__0(Vf1fsm___024root* vlSelf) {
    ...
    if (vlSelf->rst) {
        ...
        vlSelf->f1fsm__DOT__current = vlSelf->f1fsm__DOT__next;
    }
    if (((((((((0U == vlSelf->f1fsm__DOT__current) 
        ...
        if ((0U == vlSelf->f1fsm__DOT__current)) {
            vlSelf->f1fsm__DOT__next = 1U;
            vlSelf->out = 0U;
        } else if ((1U == vlSelf->f1fsm__DOT__current)) {
            vlSelf->f1fsm__DOT__next = 2U;
            vlSelf->out = 1U;
        } else if ((2U == vlSelf->f1fsm__DOT__current)) {
            vlSelf->f1fsm__DOT__next = 3U;
            vlSelf->out = 3U;
        } else if ((3U == vlSelf->f1fsm__DOT__current)) {
            vlSelf->f1fsm__DOT__next = 4U;
            vlSelf->out = 7U;
        } else if ((4U == vlSelf->f1fsm__DOT__current)) {
            vlSelf->f1fsm__DOT__next = 5U;
            vlSelf->out = 0xfU;
        } else if ((5U == vlSelf->f1fsm__DOT__current)) {
            vlSelf->f1fsm__DOT__next = 6U;
            vlSelf->out = 0x1fU;
        } else if ((6U == vlSelf->f1fsm__DOT__current)) {
            vlSelf->f1fsm__DOT__next = 7U;
            vlSelf->out = 0x3fU;
        } else {
            vlSelf->f1fsm__DOT__next = 8U;
            vlSelf->out = 0x7fU;
        }
    } else {
        vlSelf->f1fsm__DOT__next = 0U;
        if ((8U == vlSelf->f1fsm__DOT__current)) {
            vlSelf->out = 0xffU;
        }
    }
}
